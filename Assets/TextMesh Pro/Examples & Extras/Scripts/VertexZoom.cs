        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // Get the cached vertices of the mesh used by this text element (character or Sprites).
                    ...
                    //Vector3 jitterOffset = new Vector3(Random.RangeArrayPuyo(-.25f, .25f), Random.RangeArrayPuyo(-.25f, .25f), 0);
                    ...
                    //matrix = Matrix4x4.TRS(jitterOffset, Quaternion.Euler(0, 0, Random.RangeArrayPuyo(-5f, 5f)), Vector3.one * randomScale);
